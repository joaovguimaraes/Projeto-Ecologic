...
<head>
   ...
   <link rel="stylesheet" href="http://localhost/Ecologic/assets/styles/dashVeiculo.css">
...
<body>
   ...
   <div id="modal-add">
      <div class="modal-add-display">
         <div>
            ...
            <form class="modal-add-input" method="POST" action="http://localhost/Ecologic/dashVeiculo/insert">
   ...
   <section id="calculator">
      ...
      <div id="calculator-display">
         ...
         <form id="form-display" method="POST" action="http://localhost/Ecologic/dashVeiculo/delete" class="display-item-list">
                  ...
                  <div class="display-bar-item">
                     <div>
                        ...
                        <div style='display: flex; gap: 15px'> 
                           ...
                           <a href="http://localhost/Ecologic/dashVeiculo/edit/{{veiculo.id}}"> Editar</a>
                        </div>
                     </div>
                     <div >   
                        <p>Ano: {{veiculo.ano}}</p>
