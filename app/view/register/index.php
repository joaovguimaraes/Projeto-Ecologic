...
<head>
   ...
   <link rel="stylesheet" href="http://localhost/Projeto-Ecologic/assets/styles/register.css">
...
<body>
   ...
   <div id="login">
      <div id="login-content">
         <form method="POST" action="http://localhost/Projeto-Ecologic/register/register" > 
            ...
            <div id="buttons-div">
               ...
               <a class="links" href="http://localhost/Projeto-Ecologic/login/index">Voltar</a>
            </div>
         </form>
