...
<head>
   ...
   <link rel="stylesheet" href="http://ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/assets/styles/dashFinish.css">
...
<div id="modal-add">
      <div class="modal-add-display">
         <div>
            ...
            <form class="modal-add-input" method="POST" action="http://ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/dashboard/finish/{{chamado.id}}">
   ...
   <section id="calculator">
      ...
      <div id="calculator-display">
         <div style='background:#fff; padding: 25px; border: 2px solid #000'>
            <a href="http://ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/dashboard"><i class="fa-solid fa-angle-left"></i> Voltar</a>
            <br>
            ...
            <a style='margin-left: 15px'href="http://ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/dashboard/edit/{{chamado.id}}"><i class="fa-solid fa-pencil"></i> Editar</a>
         </div>
      </div>
   </section>
   <script>
