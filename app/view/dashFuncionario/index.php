...
<head>
   ...
   <link rel="stylesheet" href="http://localhost/Projeto-Ecologic/assets/styles/dashFuncionario.css">
...
<body>
   ...
   <div id="modal-add">
      <div class="modal-add-display">
         <div>
            ...
            <form class="modal-add-input" method="POST" action="http://localhost/Projeto-Ecologic/dashFuncionario/insert">
   ...
   <section id="calculator">
      ...
      <div id="calculator-display">
         ...
         <form id="form-display" method="POST" action="http://localhost/Projeto-Ecologic/dashFuncionario/delete" class="display-item-list">
                  ...
                  <div class="display-bar-item">
                     <div>
                        ...
                        <div style='display: flex; gap: 15px'> 
                           ...
                           <a href="http://localhost/Projeto-Ecologic/dashFuncionario/edit/{{funcionario.id}}">Editar</a>
                        </div>
                     </div>
                     <div>
