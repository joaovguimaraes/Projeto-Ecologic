...
<body>
   ...
   <div id="modal-add">
      <div class="modal-add-display">
         <div>
            ...
            <form class="modal-add-input" method="POST" action="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/dashFuncionario/insert">
   ...
   <section id="calculator">
      ...
      <div id="calculator-display">
         ...
         <form id="form-display" method="POST" action="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/dashFuncionario/delete" class="display-item-list">
                  ...
                  <div class="display-bar-item">
                     <div>
                        ...
                        <div style='display: flex; gap: 15px'> 
                           ...
                           <a href="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/dashFuncionario/edit/{{funcionario.id}}">Editar</a>
                        </div>
                     </div>
                     <div>
