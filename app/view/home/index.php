...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/Ecologic/assets/styles/home.css">
...
<body>
    ...
    <div id="container">
        ...
        <section id="home">
            ...
            <img id="simbol-large" src="http://localhost:8080/Ecologic/assets/images/Simbol - EcologicLarge.svg" alt="Ecologic" />
            <a href="#team-page" id="div-arrow-down">
                <img id="arrow-down" src="http://localhost:8080/Ecologic/assets/images/Vector.svg" alt="arrow down">
            </a>
        </section>
        <section id="team-page">
            <div id="team-page-content">
                ...
                <div class='cards-div'>
                    <div class="team-card"
                        style=" background-image:linear-gradient(#00000000,#00000000, #000), url(http://localhost:8080/Ecologic/assets/images/image\ 3.jpeg);">
                        <div class="team-card-content">
                            <h1 class="subtitle">João<br>Guimarães</h1>
                            <p class="paragraph">
                                20 anos, natural de Florianópolis/SC. Sua principal função desempenhada dentro do Eco2Logic foi o desenvolvimento frontend e backend.
                            </p>
                        </div>
                    </div>
                    <div class="team-card"
                        style="background-image:linear-gradient(#00000000,#00000000, #000), url(http://localhost:8080/Ecologic/assets/images/image\ 2.jpeg)">
                        <div class="team-card-content">
                            <h1 class="subtitle">Margiory<br>Simas</h1>
                            <p class="paragraph">
                                35 anos, natural de Florianópolis/SC. Sua principal função desempenhada dentro do Eco2Logic foi a Gestão de Projetos.
                            </p>
                        </div>
                    </div>
                    <div class="team-card"
                        ...
                        <div class="team-card-content">
                            ...
                            <p class="paragraph">
                                26 anos, natural de Florianópolis/SC. Sua principal função desempenhada dentro do Eco2Logic foi a Gestão de Projetos.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section id="carbon-page">
            <div id="carbon-content">
                ...
                <image id="image-fabric" src="http://localhost:8080/Ecologic/assets/images/fabric.svg" />
            </div>
        </section>
        <section id="about-page">
            <div id="carbon-content">
                ...
                <image id="image-fabric" src="http://localhost:8080/Ecologic/assets/images/transit.jpeg" />
            </div>
        </section>
        <section id="contact">
