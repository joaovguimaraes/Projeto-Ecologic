...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Ecologic/assets/styles/home.css">
...
<body>
    <nav id="header">
        ...
        <div id="div-button-header">
            <button class="pushable" onclick="location.href='http://localhost/Ecologic/login'" type="button">
                <span class="front">
                    Calcular
                </span>
            </button>
    ...
    <div id="container">
        ...
        <section id="home">
            <div id="content-home">
                ...
                <div id="div-button-menu">
                    <button class="pushable" onclick="location.href='http://localhost/Ecologic/login'">
                        <span class="front">
                            Calcular
                        </span>
                    </button>
            ...
            <img id="simbol large" height="412" src="http://localhost/Ecologic/assets/images/Simbol - EcologicLarge.svg" alt="Ecologic" />
            <a href="#team-page" id="div-arrow-down">
                <img id="arrow-down" src="http://localhost/Ecologic/assets/images/Vector.svg" alt="arrow down">
            </a>
        </section>
        <section id="team-page">
            <div id="team-page-content">
                ...
                <div style="display: flex; flex-direction: row; gap: 10vw">
                    <div class="team-card"
                        style=" background-image:linear-gradient(#00000000,#00000000, #000), url(http://localhost/Ecologic/assets/images/Rectangle\ 7.svg);">
                    ...
                    <div class="team-card"
                        style="background-image:linear-gradient(#00000000,#00000000, #000), url(http://localhost/Ecologic/assets/images/image\ 1.svg)">
                        <div class="team-card-content">
                    ...
                    <div class="team-card"
                        style="background-image: linear-gradient(#00000000,#00000000, #000), url(http://localhost/Ecologic/assets/images/image\ 2.svg);">
                        <div class="team-card-content">
        ...
        <section id="carbon-page">
            <div id="carbon-content">
                ...
                <image id="image-fabric" src="http://localhost/Ecologic/assets/images/fabric.svg" />
            </div>
        </section>
        <section id="about-page">
            <div id="carbon-content">
                ...
                <image id="image-fabric" src="http://localhost/Ecologic/assets/images/transit.jpeg" />
            </div>
        </section>
        <section id="contact">
