...
<body>
    ...
    <div id="container">
        ...
        <section id="home">
            ...
            <img id="simbol large" height="412" src="/images/Simbol - EcologicLarge.svg" alt="Ecologic" />
            <a href="#team-page" id="div-arrow-down">
                <img id="arrow-down" src="/images/Vector.svg" alt="arrow down">
            </a>
        </section>
        <section id="team-page">
            <div id="team-page-content">
                ...
                <div style="display: flex; flex-direction: row; gap: 10vw">
                    <div class="team-card"
                        style=" background-image:linear-gradient(#00000000,#00000000, #000), url(/images/Rectangle\ 7.svg);">
                    ...
                    <div class="team-card"
                        style="background-image:linear-gradient(#00000000,#00000000, #000), url(/images/image\ 1.svg)">
                        <div class="team-card-content">
                    ...
                    <div class="team-card"
                        style="background-image: linear-gradient(#00000000,#00000000, #000), url(/images/image\ 2.svg);">
                        <div class="team-card-content">
        ...
        <section id="carbon-page">
            <div id="carbon-content">
                ...
                <image id="image-fabric" src="/images/fabric.svg" />
            </div>
        </section>
        <section id="about-page">
            <div id="carbon-content">
                ...
                <image id="image-fabric" src="/images/transit.jpeg" />
            </div>
        </section>
        <section id="contact">
