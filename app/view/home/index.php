...
<body>
    ...
    <div id="container">
        ...
        <section id="home">
            ...
            <img id="simbol large" height="412" src="assets/images/Simbol - EcologicLarge.svg" alt="Ecologic" />
        ...
        <section id="team-page">
            <div id="team-page-content">
                ...
                <div style="display: flex; flex-direction: row; gap: 10vw">
                    <div class="team-card"
                        style=" background-image:linear-gradient(#00000000,#00000000, #000), url(assets/images/Rectangle\ 7.svg);">
                    ...
                    <div class="team-card"
                        style="background-image:linear-gradient(#00000000,#00000000, #000), url(assets/images/image\ 1.svg)">
                        <div class="team-card-content">
                    ...
                    <div class="team-card"
                        style="background-image: linear-gradient(#00000000,#00000000, #000), url(assets/images/image\ 2.svg);">
                        <div class="team-card-content">
