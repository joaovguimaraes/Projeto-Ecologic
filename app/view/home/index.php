...
<body>
    <nav id="header">
        ...
        <div id="div-button-header">
            <button class="pushable" onclick="location.href='http://localhost:8080/Ecologic/login'" type="button">
                <span class="front">
                    Calcular
                </span>
            </button>
        ...
        <section id="home">
            <div id="content-home">
                ...
                <div id="div-button-menu">
                    <button class="pushable" onclick="location.href='http://localhost:8080/Ecologic/login'">
                        <span class="front">
                            Calcular
                        </span>
                    </button>
            ...
            <img id="simbol large" height="412" src="http://localhost:8080/Ecologic/assets/images/Simbol - EcologicLarge.svg" alt="Ecologic" />
        ...
        <section id="team-page">
            <div id="team-page-content">
                ...
                <div style="display: flex; flex-direction: row; gap: 10vw">
                    <div class="team-card"
                        style=" background-image:linear-gradient(#00000000,#00000000, #000), url(http://localhost:8080/Ecologic/assets/images/Rectangle\ 7.svg);">
                    ...
                    <div class="team-card"
                        style="background-image:linear-gradient(#00000000,#00000000, #000), url(http://localhost:8080/Ecologic/assets/images/image\ 1.svg)">
                        <div class="team-card-content">
                    ...
                    <div class="team-card"
                        style="background-image: linear-gradient(#00000000,#00000000, #000), url(http://localhost:8080/Ecologic/assets/images/image\ 2.svg);">
                        <div class="team-card-content">
