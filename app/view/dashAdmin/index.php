...
<body>
   ...
   <div id="modal-add">
      ...
      <div class="modal-add-display">
         <div>
            ...
            <form class="modal-add-input" method="POST" action="http://localhost/Projeto-Ecologic/dashAdmin/insert">
   ...
   <div id="calculator-options">
      ...
      <div id="calculator-display">
         ...
         <form id="form-display" method="POST" action="http://localhost/Projeto-Ecologic/dashAdmin/delete" class="display-item-list">
                  ...
                  <div class="display-bar-item">
                     <div>
                        ...
                        <div 
                           ...
                           <a href="http://localhost/Projeto-Ecologic/dashAdmin/edit/{{usuario.id}}">Editar</a>
                        </div>
                     </div>
                     <div>
