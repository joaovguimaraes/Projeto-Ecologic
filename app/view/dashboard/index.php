...
<head>
   ...
   <link rel="stylesheet" href="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/assets/styles/dashboard.css">
...
<body>
   ...
   <div id="modal-add">
      <div class="modal-add-display">
         <div>
            ...
            <form class="modal-add-input" method="POST" action="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/dashboard/insert">
                  ...
                  <div class="display-bar-item">
                     <div>
                        ...
                        <div style='display: flex; gap:5px;'>
                           ...
                           <a href="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/dashboard/open/{{chamado.id}}">Mais Informações</a>
                        </div>
                     </div>
                     <div>
   ...
   <script>
      ...
      function handleDelete() {
         form.action="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/dashboard/delete";
         form.submit();
      }
      function handleFinish() {
         form.action="http://ec2-52-90-93-141.compute-1.amazonaws.com/Projeto-Ecologic/Ecologic/dashboard/finish";
         form.submit();
      }
