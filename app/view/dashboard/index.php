...
<head>
   ...
   <link rel="stylesheet" href="http://localhost/Projeto-Ecologic/assets/styles/dashboard.css">
...
<body>
   ...
   <div id="modal-add">
      <div class="modal-add-display">
         <div>
            ...
            <form class="modal-add-input" method="POST" action="http://localhost/Projeto-Ecologic/dashboard/insert">
                  ...
                  <div class="display-bar-item">
                     <div>
                        ...
                        <div style='display: flex; gap:5px;'>
                           ...
                           <a href="http://localhost/Projeto-Ecologic/dashboard/open/{{chamado.id}}">Mais Informações</a>
                        </div>
                     </div>
                     <div>
   ...
   <script>
      ...
      function handleDelete() {
         form.action="http://localhost/Projeto-Ecologic/dashboard/delete";
         form.submit();
      }
      function handleFinish() {
         form.action="http://localhost/Projeto-Ecologic/dashboard/finish";
         form.submit();
      }
