<?php 
   ...
   class DashboardController{
      ...
      public function finish($id){
         ...
         header('location: ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/dashboard/open/'.$id[0]);
         }catch(\Exception $e){
      ...
      public function update($id){
         try {
            ...
            $_SESSION['msg_error'] = array('msg' => $e->getMessage(), 'count' => 0);
            header('location: ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/dashboard/edit/'.$id[0]);
         }
      }
