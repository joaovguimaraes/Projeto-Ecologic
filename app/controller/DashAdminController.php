   ...
   class DashAdminController{
      ...
      public function delete(){
         $user = new User;
            ...
            header('location: http://ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/dashAdmin');
         }catch(\Exception $e){
      ...
      public function update($id){
         try {
            ...
            $_SESSION['msg_error'] = array('msg' => $e->getMessage(), 'count' => 0);
            header('location: http://ec2-52-90-93-141.compute-1.amazonaws.com/Ecologic/dashAdmin/edit/'.$id[0]);
         }
      }    
